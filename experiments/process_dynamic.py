...
def main():
    ...
    for agg in aggregators:
        agg_to_func[agg.name] = u.read_throughput('dynamic', agg.name, functions)

    u.make_small_window_varying_graphs('Dynamic', 'dynamic', 'max window size in data items', aggregators, 
